...
import com.example.crudwithvaadin.security.CustomRequestCache;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    private static final String LOGIN_SUCCESS_URL = "/dbutil";
    ...
    public UserDetailsService userDetailsService() {
        ...
        return new InMemoryUserDetailsManager(uDetails);
    }
